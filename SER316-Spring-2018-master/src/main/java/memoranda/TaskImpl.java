...
public class TaskImpl extends BaseImpl implements ITask, Comparable {
    ...
    public CalendarDate getStartDate() {
        return new CalendarDate(_root.getAttribute("startDate").getValue());
    }
    ...
    public CalendarDate getEndDate() {
		String ed = _root.getAttribute("endDate").getValue();
		if (ed != "")
			return new CalendarDate(_root.getAttribute("endDate").getValue());
    ...
    public long getEffort() {
    	Attribute attr = _root.getAttribute("effort");
    	if (attr == null) {
    		return 0;
    	}
    	else {
	...
	public ITask getParentTask() {
		Node parentNode = _root.getParent();
...
*/
    ...
    public String getText() {
        return _root.getFirstChildElement("text").getValue();
    }
    ...
    public void setText(String s) {
        _root.getFirstChildElement("text").removeChildren();
        _root.getFirstChildElement("text").appendChild(s);
    }
    ...
    public Collection getDependsFrom() {
        Vector v = new Vector();
        Elements deps = _root.getChildElements("dependsFrom");
    ...
    public int getProgress() {
        return new Integer(_root.getAttribute("progress").getValue()).intValue();
    }
    /**
    ...
    public int getPriority() {
        Attribute pa = _root.getAttribute("priority");
        if (pa == null)
    ...
    private void setAttr(String a, String value) {
        Attribute attr = _root.getAttribute(a);
        if (attr == null)
           _root.addAttribute(new Attribute(a, value));
        else
            attr.setValue(value);
    }
...
*/
	...
	public Collection getSubTasks() {
		Elements subTasks = _root.getChildElements("task");
